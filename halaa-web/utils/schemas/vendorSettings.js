...
export const personalInfoSchema = (t) => ({
  ...
  fields: [
    ...
    { name: "phoneNumber", type: FIELD_TYPES.TEL, labelKey: "personalInfo.phoneWhatsapp", labelAr: "رقم الجوال / واتساب", placeholderKey: "personalInfo.phonePlaceholder", placeholderAr: "+966 5XX XXX XXXX", required: false },
