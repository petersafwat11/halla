...
/* Owner-approved contact facts from the shared legal source. */
const CONTACT_EMAIL = `mailto:${LEGAL_CONTACT.supportEmail.value}`;
const CONTACT_WA = `https://wa.me/${String(LEGAL_CONTACT.whatsapp.value).replace(/[^0-9]/g, "")}`;
