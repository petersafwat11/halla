...
const locationSchema = new mongoose.Schema(
  {
    ...
    latitude: {
      type: Number,
      required: [function () { return this.provider !== 'manual' || this.longitude != null; }, "Latitude is required"],
      min: [-90, "Latitude must be between -90 and 90"],
      max: [90, "Latitude must be between -90 and 90"],
    },
    longitude: {
      type: Number,
      required: [function () { return this.provider !== 'manual' || this.latitude != null; }, "Longitude is required"],
    ...
    provider: {
      type: String,
      enum: ["google", "azure", "device", "manual"],
      default: "google",
    },
  },
  { _id: false }
