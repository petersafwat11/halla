/**
 * Strict Card validation, formatting, and Moyasar wire-normalization utilities (Backend CJS).
 */

/**
 * Format raw expiry input while user is typing or pasting into an MM/YY field.
 */
function formatExpiryInput(input = "", prevInput = "") {
...
/**
 * Parses any expiry representation into normalized 2-digit month and 4-digit year.
 */
 ...
 */
function validateCardExpiry(monthInput, yearInput, referenceDate = new Date()) {
 ...
 */
function buildCreditCardSource(cardData = {}) {
