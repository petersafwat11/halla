...
test("RTL-03: TicketCard uses formatDateTime and isolateLtr for unified date-time rendering", () => {
  ...
  assert.ok(content.includes("isolateLtr(formattedDate)"), "TicketCard must wrap formattedDate in isolateLtr");
