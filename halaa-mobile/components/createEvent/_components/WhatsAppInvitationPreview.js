...
const styles = StyleSheet.create({
  ...
  waEventName: { fontSize: 15, fontFamily: "Cairo_700Bold", color: "#2C2C2C", marginBottom: 4 },
  waMessage: { fontSize: 13, fontFamily: "Cairo_400Regular", color: "#2C2C2C", lineHeight: 22 },
  waMessageEmpty: { fontSize: 12, fontFamily: "Cairo_400Regular", color: "#999", fontStyle: "italic", lineHeight: 18 },
  waTemplateBadge: { marginTop: 6, alignSelf: "flex-start", backgroundColor: "#F5ECE4", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12 },
