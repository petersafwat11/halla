...
const COPY = {
  ar: {
    reply_and_qr: { title: 'تأكيد الحضور مع رمز دخول', description: 'زر تأكيد وزر اعتذار. عند التأكيد يصل رمز QR مع ردك وتفاصيل المناسبة.' },
    reply_only: { title: 'تأكيد الحضور برسالة', description: 'زر تأكيد وزر اعتذار. عند التأكيد يصل نص ردك فقط، دون رمز دخول أو تفاصيل إضافية.' },
