/**
 * statusColors — single source of truth for status-badge colors (WEB).
 *
 * Mirror of halla-mobile/constants/statusColors.js — the two files MUST keep
 * identical tone hexes and the identical status→tone map so a given status
 * shows the SAME color on web and mobile.
 *
