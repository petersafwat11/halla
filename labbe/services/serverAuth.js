...
export const ROLE_PAGE_ACCESS = {
  ...
  [USER_ROLES.WHITELABEL_ADMIN]: {
    [ADMIN_PAGES.DASHBOARD]: ACCESS_LEVELS.FULL,
    [ADMIN_PAGES.HOSTS]: ACCESS_LEVELS.NONE,
    ...
    [ADMIN_PAGES.WHITELABELS]: ACCESS_LEVELS.NONE,
    [ADMIN_PAGES.SETTINGS]: ACCESS_LEVELS.FULL,
    [ADMIN_PAGES.TEMPLATES]: ACCESS_LEVELS.NONE,
    [ADMIN_PAGES.TEMPLATE_CATEGORIES]: ACCESS_LEVELS.NONE,
    [ADMIN_PAGES.TAQNYAT_TEMPLATES]: ACCESS_LEVELS.NONE,
    [ADMIN_PAGES.DISCOUNTS]: ACCESS_LEVELS.NONE,
  },
  [USER_ROLES.WHITELABEL_MODERATOR]: {
...
/**
 * Check if current user is a whitelabel user
 * @returns {boolean}
 */
export async function isWhitelabelUser() {
  const userRole = await getUserRole();
  return WHITELABEL_ROLES.includes(userRole);
}
